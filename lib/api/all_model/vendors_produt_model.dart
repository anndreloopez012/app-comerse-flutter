...
class vendors_products_model {
  ...
  vendors_products_model(
      {this.status, this.message, this.data, this.vendordetails, this.banners});

  vendors_products_model.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Vendordetails {
  ...
  Vendordetails(
      {this.mobile, this.email, this.storeAddress, this.id, this.rattings});
